...
const Blogtext = () => {
  ...
  return (
    <div>
      <motion.div style={{ scaleX }} className="progress-bar fixed top-0 left-0 right-0 h-[1rem] bg-primary origin-[0%]"></motion.div>
      <motion.div className="container mx-auto mt-[10rem] md:mt-[5rem] mb-[5rem]">
        ...
        <p className="text-white text-[1.6rem]">
          ...
          tellus ligula ultrices mauris, at condimentum erat risus id ante.
          Nullam pulvinar lorem eget luctus vestibulum. Vestibulum volutpat
          malesuada ante, eget tempor massa. Quisque maximus sagittis suscipit.
          Vivamus placerat, magna eget pulvinar sodales, sem nibh elementum
          justo, ac elementum ipsum lacus non tellus. In hac habitasse platea
          dictumst. Proin magna dolor, vestibulum vitae orci dapibus, commodo
          eleifend nulla. Integer tincidunt dictum neque ac tempus. Aliquam in
          laoreet nisi. Ut nec libero dolor. Class aptent taciti sociosqu ad
          litora torquent per conubia nostra, per inceptos himenaeos. Maecenas
          gravida, lorem et sagittis ullamcorper, erat est rutrum lacus, in
          mollis risus mauris a nisi. Nullam non nisi nec ligula elementum
          cursus pulvinar nec libero.Class aptent taciti sociosqu ad litora
          ...
          mauris a nisi. Nullam non nisi nec ligula elementum cursus pulvinar
          nec libero.
          Morbi ac nulla felis. Vestibulum maximus, mi eget finibus commodo,
          tellus ligula ultrices mauris, at condimentum erat risus id ante.
          Nullam pulvinar lorem eget luctus vestibulum. Vestibulum volutpat
